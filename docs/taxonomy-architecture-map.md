...
| 10. Guardrails and governance | Safety policy, approval boundary, review rule, or non-goal list | governance policy, safety guidance, warning reference | `agent/governance/policy.md`, `agent/policies/public-safety.md`, `docs/public-safety.md`, `docs/warnings-and-overlap.md`, README safety and non-goals | Defines approval, refusal, redirect, public/private, certification, endorsement, and human-decision boundaries for both layers. |
